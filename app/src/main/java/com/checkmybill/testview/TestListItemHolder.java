 ...
 */
public class TestListItemHolder extends RecyclerView.ViewHolder {
    ...
    private LinearLayout bottom_buttons_area;
    private CheckBox compute_entry_cb;

    public TestListItemHolder(View v) {
        super(v);
        ...
        bottom_buttons_area = (LinearLayout) v.findViewById(R.id.bottom_buttons_area);
        compute_entry_cb = (CheckBox) v.findViewById(R.id.compute_entry_cb);
    }
    ...
    public void changeVisibilityBottomArea(int visibility) {
        this.bottom_buttons_area.setVisibility(visibility);
    }

    public void setCheckboxAsChecked(boolean checked) {
        this.compute_entry_cb.setChecked(checked);
    }

    public boolean getCheckboxAsChecked() {
        return this.compute_entry_cb.isChecked();
    }
    public CheckBox getCheckboxAsCheckedView() {
        return this.compute_entry_cb;
    }
}
