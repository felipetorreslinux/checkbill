...
@EFragment(R.layout.fragment_ranking_gsm)
public class GsmRankingFragment extends BaseFragment {
    ...
    public GsmRankingFragment() {
    }

    public static GsmRankingFragment newInstance(int sectionNumber) {
        GsmRankingFragment fragment = new GsmRankingFragment();
    ...
    private void getRanking() {
        ...
        JsonObjectRequest jsonObjectRequest = RankingRequester.prepareRankingGsmRequest(responseListener, erroListener, getActivity(), area, exibicao, inicioData, fimData);
    ...
    private void initVolleyLinsteners(){
        responseListener = new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                List<GsmRankingItem> gsmRankingItemList = RankingRequester.parserRankingGsmRequest(response);

                if (gsmRankingItemList != null && !gsmRankingItemList.isEmpty() ) {

                    AdapterRankingGsm adapterNetworkQuality = new AdapterRankingGsm(getActivity(), gsmRankingItemList, R.layout.list_ranking_gsm, new CustomItemClickListener() {
                        @Override
                        public void onItemClick(View v, int position) {
                            //nothing
                        }
                    });
                    list.setAdapter(adapterNetworkQuality);
