...
@DatabaseTable(tableName = "mobile_traffic_monitor")
public class TrafficMonitor_Mobile {
    @DatabaseField(allowGeneratedIdInsert = true, generatedId = true, canBeNull = false, columnName = "id_mob_monitor") private long idMonitor;
